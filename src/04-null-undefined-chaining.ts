...
let title2; // this will be initialized as undefined
let title3 = undefined; // this will be initialized as undefined
...
if (course.title) { console.log(`The title is ${course.title}`);}
...
const title = course3 ?? "No title found";
console.log(title);
