function createCourse(title, subtitle, lessonsCount) {
    ...
    return { title: title, subtitle: subtitle, lessonsCount: lessonsCount };
}
var result = createCourse("TypeScript Bootcamp", "Learn the Fundamentals", 10);
...
function createCourse2(title, subtitle, lessonsCount) {
    console.log("Title: ".concat(title, ", Subtitle: ").concat(subtitle, ", Lessons Count: ").concat(lessonsCount));
    return { title: title, subtitle: subtitle, lessonsCount: lessonsCount };
}
var result2 = createCourse2("TypeScript Bootcamp", "Learn the Fundamentals", 10);
